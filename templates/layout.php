            ...
            <div class="menu-section">
                ...
                <?php foreach ($categories as $catSlug => $catInfo): ?>
                    <div class="menu-category">
                        <a href="/?cat=<?php echo urlencode($catSlug); ?>"
                           class="menu-category-title <?php echo ($currentCat && $currentCat['slug'] === $catSlug && $currentPage === null) ? 'active' : ''; ?>">
                        ...
                        <?php if (!empty($catInfo['pages'])): ?>
                            <ul class="menu-sublist">
                                <?php foreach ($catInfo['pages'] as $pageSlug => $pageInfo): ?>
                                    <li>
                                        <a href="/?cat=<?php echo urlencode($catSlug); ?>&page=<?php echo urlencode($pageSlug); ?>"
                                           class="<?php echo ($currentCat && $currentPage && $currentCat['slug'] === $catSlug && $currentPage['slug'] === $pageSlug) ? 'active' : ''; ?>">
